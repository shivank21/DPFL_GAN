...
class ConvGanLossFns(AbstractGanLossFns):
    """A class defining GAN Losses for Convolutional GANs."""
    
    def generator_loss(self, generator: tf.keras.Model,
                       discriminator: tf.keras.Model, gen_inputs):
        """Compute the generator loss for Convolutional GANs."""
        fake_output = discriminator(generator(gen_inputs))
        return tf.keras.losses.BinaryCrossentropy(from_logits=True)(tf.ones_like(fake_output), fake_output)

    def discriminator_loss(self, generator: tf.keras.Model,
                           discriminator: tf.keras.Model, gen_inputs, real_data):
        """Compute the discriminator loss for Convolutional GANs."""
